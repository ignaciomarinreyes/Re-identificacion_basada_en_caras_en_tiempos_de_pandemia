...
img = cv2.imread("/content/gdrive/My Drive/TFG/insightface/detection/RetinaFaceAntiCov/images/n2.jpeg")
print(img.shape)
im_shape = img.shape
...
if faces is not None:
    ...
    filename = '/content/gdrive/My Drive/TFG/insightface/detection/RetinaFaceAntiCov/images/salida.jpeg'
