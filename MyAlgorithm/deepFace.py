...
def rank1DeepFace():
    model_names = ["Facenet", "OpenFace", "DeepFace", "DeepID", "Dlib", "ArcFace"]
...
def distanceDeepFaceInterVideo():
    ...
    for model in model_names:
        print("============= " + model + " ===================")
        for dirpath1, dirnames1, filenames1 in sorted(os.walk(params.path)):
            ...
            for file1 in sorted(filenames1):
                ...
                fileObj = Path(dirpath1 + "/" + timeFile1 + "_" + id1 + "_" + model + "_deepFaceInterDistance.txt")
                if not fileObj.exists():
                    ...
                    for dirpath2, dirnames2, filenames2 in sorted(os.walk(params.path)):
                    ...
                    print("Existe " + dirpath1 + "/" + timeFile1 + "_" + id1 + "_" + model + "_deepFaceInterDistance.txt")
            ...
            for modelName in model_names:
                ...
                if not fileObj.exists():
                    try:
                        ...
                        result = DeepFace.represent(dirpath + "/" + timeFile + "_" + id + "_body.jpg", model_name=modelName, enforce_detection=False)
                    except:
                        print("No se puede aplicar algoritmo" + dirpath + "/" + timeFile + "_" + id + "_body.jpg"  + " ===> " + modelName)
