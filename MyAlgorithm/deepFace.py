...
def distanceVectorFeature(vImage1, vImage2, distance_metric = 'cosine'):
		#metrics = ["cosine", "euclidean", "euclidean_l2"]
		if distance_metric == 'cosine':
			distance = dst.findCosineDistance(vImage1, vImage2)
		elif distance_metric == 'euclidean':
			distance = dst.findEuclideanDistance(vImage1, vImage2)
		elif distance_metric == 'euclidean_l2':
			distance = dst.findEuclideanDistance(dst.l2_normalize(vImage1), dst.l2_normalize(vImage2))
		else:
            ...
            for dirpath2, dirnames2, filenames2 in os.walk(params.path):
                ...
                for file2 in sorted(filenames2):
                    ...
                    if place1 != place2:
                        ...
                        distance = distanceVectorFeature(vectorFeature1, vectorFeature2)
                        fileOutput.write(place1 + " " + timeFile1 + " " + id1 + " " + place2 + " " + timeFile2 + " " + id2 + " " +  str(distance) + " \n")
